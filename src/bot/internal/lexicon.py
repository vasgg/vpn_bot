...
texts = {
    ...
    'user_created': 'Welcome, {user_fullname}, you have 1 week demo access!\n\nYour ID: <code>{user_id}</code>\n'
                    '├ your status: <b>{status}</b>\n'
                    '├ proxy type: <b>{proxy_type}</b>\n'
                    '├ valid until: <b>{valid_until}</b>\n'
                    '└ days left: <b>{days_left}</b>\n\n',
    ...
    'user_not_expired': 'Hello, {user_fullname}!\n\n{Your ID: <code>{user_id}</code>\n'
                        ...
                        '├ valid until: <b>{valid_until}</b>\n'
                        '└ days left: <b>{days_left}</b>\n\n',
    'user_expired': 'Hello, {user_fullname}!\n'
                    '└ your status: <b>{status}</b>\n',
    'renew_subscription': 'Successfully added {month_amount} months to your subscription.\n'
                          '├ your status: <b>{status}</b>\n'
                          '├ proxy type: <b>{proxy_type}</b>\n'
                          '├ valid until: <b>{valid_until}</b>\n'
                          '└ days left: <b>{days_left}</b>\n\n',
